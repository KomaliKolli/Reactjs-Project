...
import MealItem from "./MealItem";
import RecipeIndex from "./RecipeIndex"; // Corrected typo in import
...
const Meal = () => {
    ...
    return (
        <>
            ...
            <div className="heading">
                <h1>Search Your Food Recipe</h1>
                <h4 style={{color:"red"}}>Search your favourite food recepie and enjoy the food. Love to have food and eat the food!</h4>
             </div>
            <div className="searchBox">
                <input type="search" className="search-bar" onChange={e=> setSearch(e.target.value)} onKeyPress={searchRecipe}/>
            </div>
